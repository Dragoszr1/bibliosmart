  ...
  <div class="min-h-screen bg-base flex items-center justify-center px-4">
    <div class="bg-papyrus-light rounded-2xl shadow-card border border-[#8b4513]/10 p-8 max-w-md w-full text-center">
      ...
      <div v-else-if="state === 'not_logged_in'">
        <i class="pi pi-lock text-4xl text-[#8b4513] mb-4"></i>
        ...
        <router-link
          ...
          class="inline-block px-6 py-2.5 bg-[#8b4513] hover:bg-[#8b4513]/90 text-white font-semibold rounded-lg text-sm transition-all"
        >
          Conectare
        </router-link>
      </div>
      ...
      <div v-else-if="state === 'already_member'">
        ...
        <router-link to="/club" class="inline-block px-6 py-2.5 bg-[#8b4513] hover:bg-[#8b4513]/90 text-white font-semibold rounded-lg text-sm transition-all">
          Mergi la Club
        </router-link>
      </div>
      ...
      <div v-else-if="state === 'success'">
        <i class="pi pi-star-fill text-4xl text-[#8b4513] mb-4"></i>
